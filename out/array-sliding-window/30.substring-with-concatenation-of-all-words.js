...
//   let firstLetterMap = new Map<string, number>();
//   let substringLen = numOfWords * wordLen;
//   let answer = [];
//   for(let word of words){
//     wordCountMap.set(word, (wordCountMap.get(word) ?? 0 ) + 1);
//     firstLetterMap.set(word[0],1);
//   }
...
//   return k == numOfWords;
// }
/// answer2: sliding window
// @lc code=end
//# sourceMappingURL=30.substring-with-concatenation-of-all-words.js.map